...
class RealtimePresence extends eventemitter_1.default {
    ...
    async leaveClient(clientId, data) {
        ...
        switch (channel.state) {
            ...
            // eslint-disable-next-line no-fallthrough
            default: {
                const err = new errorinfo_1.PartialErrorInfo('Unable to leave presence channel while in ' + channel.state + ' state', 90001);
                err.code = 90001;
                throw err;
            }
        }
...
class Transport extends eventemitter_1.default {
    ...
    onActivity() {
        ...
        this.lastActivity = this.connectionManager.lastActivity = platform_1.default.Config.now();
...
function detectV1Callback(args, v2TrailingFnArity) {
    ...
    if (n <= v2TrailingFnArity && typeof args[n - 2] !== 'function')
        return;
    const err = new errorinfo_1.default('v1 callback signature is no longer supported.', 40025, 400);
    err.hint =
