...
function detectV1Callback(args, v2TrailingFnArity) {
  ...
  err.hint = "v2 uses Promises \u2014 drop the trailing callback and `await` the returned promise. See https://github.com/ably/ably-js/blob/main/docs/migration-guides/v2/lib.md";
  throw err;
}
...
var RealtimePresence = class extends eventemitter_default {
  ...
  async leaveClient(clientId, data) {
    ...
    switch (channel.state) {
      ...
      default: {
        const err = new PartialErrorInfo("Unable to leave presence channel while in " + channel.state + " state", 90001);
        err.code = 90001;
        throw err;
      }
    }
