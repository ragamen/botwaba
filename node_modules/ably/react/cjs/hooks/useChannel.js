...
function useChannel(channelNameOrNameAndOptionsOrCallback, eventOrCallback, callback) {
    ...
    const channelNameOrNameAndOptions = inferChannelFromNearestProvider
        ? undefined
        : channelNameOrNameAndOptionsOrCallback;
    ...
    const { channel, derived, channelName } = (0, useChannelInstance_js_1.useChannelInstance)(channelHookOptions.ablyId, channelHookOptions.channelName);
    ...
    const history = (0, react_1.useMemo)(() => ((params) => channel.history(params)), [channel]);
