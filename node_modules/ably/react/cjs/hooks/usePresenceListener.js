...
function usePresenceListener(channelNameOrNameAndOptionsOrListener, onPresenceMessageReceived) {
    ...
    const onPresenceMessageReceivedRef = (0, react_1.useRef)(listener);
    (0, react_1.useEffect)(() => {
